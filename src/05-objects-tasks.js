...
function fromJSON(proto, json) {
  ...
  const parseJSON = Object.entries(JSON.parse(json));
  parseJSON.forEach((param) => {
...
// error: (newi) => {
//   if (this.i > newi) throw new Error(
// 'Selector parts should be arranged in the following order: element, id, class, attribute,
// pseudo-class, pseudo-element');
//   if (this.i === newi && (newi === 1 || newi === 2 || newi === 6)) throw new Error(
...
// console.log('b', cssSelectorBuilder.element('div'));
